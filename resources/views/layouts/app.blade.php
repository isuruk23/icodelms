    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="/dashboard">
                ...
                <div class="sidebar-brand-text mx-3">PodiPodiWada</div>
            </a>
              ...
              <li class="nav-item">
                ...
                <div id="collapseStudents" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/students">Students Details</a>
                    </div>
                </div>
            </li>
             <!-- Nav Item - Pages Collapse Menu -->
              <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseInstitute"
                    aria-expanded="true" aria-controls="collapseInstitute">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Institute</span>
                </a>
                <div id="collapseInstitute" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <h6 class="collapse-header">Institute:</h6>
                        <a class="collapse-item" href="/institutes">Institute Details</a>
                        <a class="collapse-item" href="/branches">Branches Details</a>
                        <a class="collapse-item" href="/classes">Classes Details</a>
                        <a class="collapse-item" href="/courses">Courses Details</a>
                        <a class="collapse-item" href="/teachers">Teachers Details</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/districts">Districts</a>
                        <a class="collapse-item" href="/cities">Cities</a>
                        <a class="collapse-item" href="/service_types">Service Types</a>
                    </div>
                </div>
            </li>
